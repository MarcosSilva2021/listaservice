package br.edu.unichristus.listaservice.funcionario.data.model;
...
public class Funcionario {
	...
	public Funcionario(Long id, String nome, String email, String endereco , String login, String password) {
		super();
		this.id = id;
		this.nome = nome;
		this.email = email;
